...
% Check and load the exist background and bacteria data. by Jiagui
if ~isempty(dir('*totalBinary_foregr.mat'))
    SavedBackground = load ('totalBinary_foregr.mat')
    SavedForegr = load ('totalBinary_backr.mat');
end
...
%%Save the totalBinary_foregr and totalBinary_backr for next time by Jiagui
save([Name '_totalBinary_foregr.mat'],'totalBinary_foregr');
save([Name '_totalBinary_backr.mat'],'totalBinary_backr');
